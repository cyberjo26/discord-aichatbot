...
export function setupEnv(extra = {}) {
  ...
  process.env.USER_MEMORY_DB_PATH = path.join(TEMP_ROOT, 'user-memory.db');
  ...
  // Per-guild setting getters fall back to config (.env) values — force
  // empties so a developer's real .env can't bleed into assertions.
  process.env.WELCOME_CHANNEL_ID = '';
  process.env.ANNOUNCE_CHANNEL_ID = '';
  process.env.VOICEMASTER_HUB_ID = '';
