 ...
 * Always returns a fresh array — callers mutate the return value
 * (addReactionRole pushes into it), so a shared default array would leak
 * one guild's bindings into every other guild's settings.
