...
export function parseAbsoluteTime(text, timezone = 'Asia/Bangkok') {
  ...
  if (hasPagi) {
    ...
    // "Siang" is roughly 10:00–14:00. Hours 10–11 with "siang" are genuine
    // late morning (no shift). Hours 1–9 with "siang" (e.g. "jam 6 siang")
    // are PM usage in casual Indonesian, so shift them +12.
